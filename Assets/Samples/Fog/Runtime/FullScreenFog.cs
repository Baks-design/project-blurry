...
namespace Meryuhi.Rendering
{
    ...
    public class FullScreenFog : VolumeComponent, IPostProcessComponent
    {
        ...
        public static bool UseEndLine(FullScreenFogMode mode, FullScreenFogDensityMode densityMode) => UseStartLine(mode) && densityMode == FullScreenFogDensityMode.Linear;
        /// <summary>
        /// Start height.
        /// </summary>
        ...
        public static bool UseEndHeight(FullScreenFogMode mode, FullScreenFogDensityMode densityMode) => UseStartHeight(mode) && densityMode == FullScreenFogDensityMode.Linear;
        /// <summary>
        /// Factor of the density mode.
        /// </summary>
        [Tooltip("Factor of the density mode.")]
        public ClampedFloatParameter density = new (0.1f, 0f, 1f);
        public static bool UseIntensity(FullScreenFogDensityMode mode) => mode == FullScreenFogDensityMode.Exponential || mode == FullScreenFogDensityMode.ExponentialSquared;
