...
namespace Assets.Scripts.Runtime.Systems.Inventory.Manipulators
{
    public class PanelDragManipulator : PointerManipulator
    {
        ...
        public PanelDragManipulator() => activators.Add(new ManipulatorActivationFilter { button = MouseButton.LeftMouse });
